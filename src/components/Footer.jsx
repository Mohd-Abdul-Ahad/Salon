        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div data-aos="fade-up">
            <div className="flex items-center mb-6">
              <span className="text-3xl font-serif font-bold text-pink-600">
                LUXE
              </span>
            ...
            <p className="text-gray-400 mb-6">
              Luxury beauty salon offering premium services with exceptional
          ...
          <div data-aos="fade-up" data-aos-delay="300">
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 mr-3 mt-1 text-pink-600"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
              ...
              <li className="flex items-center">
                ...
                <span>info@yoursalonname.com</span>
              </li>
              <li className="flex items-center">
                <svg
                  className="w-5 h-5 mr-3 text-pink-600"
